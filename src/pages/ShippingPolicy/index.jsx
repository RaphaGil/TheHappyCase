      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-yellow-50 rounded-lg p-6 md:p-8 border border-yellow-100">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed space-y-2 ml-4 mb-4" style={{fontFamily: "'Poppins', sans-serif"}}>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mt-4" style={{fontFamily: "'Poppins', sans-serif"}}>
