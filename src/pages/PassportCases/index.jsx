...
import { faChevronDown, faChevronUp, faShieldAlt, faTag, faTruck } from '@fortawesome/free-solid-svg-icons';
            ...
            {selectedCase.specifications && (
              <div className="">
                <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                  {selectedCase.specifications.rfid && selectedCase.specifications.rfid.toLowerCase() === 'yes' && (
                  ...
                  {selectedCase.specifications.material && (
                    <p className="text-sm text-gray-900 font-inter flex items-center gap-2">
                      ...
                      <span className="font-bold">Material:</span> {selectedCase.specifications.material}
                    </p>
                  )}
                </div>
              </div>
