    ...
    <div className="border-b border-gray-200 bg-white">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 lg:px-6 py-5">
        ...
        >
          ...
          {totalQuantity > 0 && (
            <span className="absolute top-0 right-0 bg-btn-primary-blue text-btn-primary-blue-text text-xs rounded-full h-5 w-5 flex items-center justify-center font-light">
              {totalQuantity}
            </span>
          )}
        </Link>
