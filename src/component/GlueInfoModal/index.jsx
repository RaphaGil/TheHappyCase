    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={onProceed}
            className="flex-1 px-4 py-2 text-xs uppercase tracking-wider text-gray-600 hover:text-gray-900 border border-gray-200 hover:border-gray-400 transition-all duration-200"
          ...
          <Link
            to="/CreateYours"
            onClick={onClose}
            className="flex-1 px-4 py-2 text-xs uppercase tracking-wider text-white bg-green-600 hover:bg-green-700 border border-green-600 hover:border-green-700 transition-all duration-200 text-center"
            style={{fontFamily: "'Poppins', sans-serif"}}
          >
            Go to Create Yours
          </Link>
