...
const MobileAddTextSection = ({
  ...
  return (
    <div id={sectionId} className="space-y-2">
      {showHeading && (
        <h3
          className="text-sm uppercase tracking-wider text-gray-900 font-medium flex items-center gap-2"
