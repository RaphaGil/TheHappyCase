...
import { faBriefcase, faPlane, faFont } from '@fortawesome/free-solid-svg-icons';
...
const MobileStepButtons = ({
  ...
  return (
    <div className="mb-3 xs:mb-4 flex justify-center overflow-x-auto pb-1">
      <div className="grid grid-cols-3 gap-4 xs:gap-2 sm:gap-2.5 max-w-fit min-w-0 flex-shrink-0">
        <button
          type="button"
          onClick={onCaseClick}
        ...
        >
          <FontAwesomeIcon
            icon={faBriefcase}
            className="w-4 h-4 xs:w-5 xs:h-5 flex-shrink-0 text-btn-primary-blue-text"
          />
          <span
            className="text-xs xs:text-sm font-bold uppercase tracking-wide leading-tight truncate max-w-full text-btn-primary-blue-text"
        ...
        >
          <FontAwesomeIcon
            ...
            className={`w-4 h-4 xs:w-5 xs:h-5 flex-shrink-0 ${
              !selectedCaseType || !selectedColor ? 'text-gray-400' : 'text-btn-primary-blue-text'
            }`}
          />
          <span
            className={`text-xs xs:text-sm font-bold uppercase tracking-wide leading-tight truncate max-w-full ${
              !selectedCaseType || !selectedColor ? 'text-gray-400' : 'text-btn-primary-blue-text'
            }`}
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
