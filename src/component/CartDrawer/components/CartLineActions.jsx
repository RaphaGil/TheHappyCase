...
const CartLineActions = ({
  ...
  return (
    <div className="mt-3 flex justify-between  gap-3 rounded-sm border border-gray-100 bg-gray-50/90 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
      ...
      <div className="flex flex-wrap items-end justify-between gap-3 sm:flex-nowrap sm:items-center sm:justify-end sm:gap-6">
        ...
        <button
          type="button"
          onClick={onRemove}
          className="inline-flex min-h-[64px] shrink-0 items-center justify-center  rounded-sm border border-transparent px-3 text-sm font-medium text-red-600 transition-colors hover:border-red-100 hover:bg-red-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-300 focus-visible:ring-offset-2 font-inter"
